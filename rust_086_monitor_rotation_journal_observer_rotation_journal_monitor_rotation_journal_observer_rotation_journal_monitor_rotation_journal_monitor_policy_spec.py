#!/usr/bin/env python3
"""RUST-086 static policy for TEST-ONLY RUST-085 checkpoint monitoring."""
...
DOC = ROOT / "docs/history/rust/RUST_086.md"
VERIFY = ROOT / "rust_086_monitor_rotation_journal_observer_rotation_journal_monitor_rotation_journal_observer_rotation_journal_monitor_rotation_journal_monitor_verify.py"
FIXTURE = ROOT / "rust_086_monitor_rotation_journal_observer_rotation_journal_monitor_rotation_journal_observer_rotation_journal_monitor_rotation_journal_monitor_fixture.py"
SELFTEST = ROOT / "rust_086_monitor_rotation_journal_observer_rotation_journal_monitor_rotation_journal_observer_rotation_journal_monitor_rotation_journal_monitor_selftest.py"
WORKFLOW = ROOT / ".github/workflows/native-monitor-rotation-journal-observer-rotation-journal-monitor-rotation-journal-observer-rotation-journal-monitor-rotation-journal-monitor.yml"
...
def main() -> None:
    ...
    require(
        ...
        (
            "THRESHOLD = 2",
            "production RUST-086 monitor-rotation-journal monitoring forbidden",
            "observed monitor same-parent RUST-085 monitor rotation journal checkpoint fork",
    ...
    require(
        fixture,
        (
            '"aa" * 32', '"ba" * 32', '"ca" * 32', "Ed25519PrivateKey",
            "RUST-086 TEST-only monitor public-key pin mismatch",
        ),
    ...
    require(
        ...
        (
            ...
            'test ! -e "$c/rust_086_monitor_rotation_journal_observer_rotation_journal_monitor_rotation_journal_observer_rotation_journal_monitor_rotation_journal_monitor_fixture.py"',
            'test "$(find "$c" -maxdepth 1 -type f | wc -l)" -eq 59',
            "expected 144 RUST-085 paths", "expected 145 RUST-086 paths",
            "axven-rust086-monitor-bundle.json",
        ),
        "RUST-086 workflow",
    )
    for forbidden in (
    ...
    require(
        ...
        (
            ...
            "exact RUST-085 final checkpoint SHA-256",
            "same-parent", "RUST-085 checkpoint replay",
