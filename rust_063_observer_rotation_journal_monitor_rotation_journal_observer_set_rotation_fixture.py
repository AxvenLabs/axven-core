#!/usr/bin/env python3
"""RUST-063 TEST-ONLY monitor-rotation-journal observer rotation producer."""
...
def main() -> None:
    if (
        ...
        raise SystemExit(
            "usage: rust_063_observer_rotation_journal_monitor_rotation_journal_observer_set_rotation_fixture.py SOURCE_SHA"
        )
    ...
    _, old_fork_bundle = floor_verify.load_canonical(
        OUT / "axven-rust062-observed-fork-bundle.json",
    ...
    print("RUST-063 TEST-only monitor-rotation-journal observer set rotation fixture: GREEN")
