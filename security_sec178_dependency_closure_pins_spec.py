...
def main():
    ...
    green("validation workflow pins packaging, installs recovery test extra, and checks compatibility",'"packaging==26.3"' in workflow and '.[legacy-mldsa-recovery]' in workflow and "python -m pip check" in workflow)
