#!/usr/bin/env python3
"""SEC-169 RPC method-specific parameter canonicality contract."""
...
def main():
    ...
    expect_error(dispatcher,"__sec169_unknown__",{},"unknown method")
    ...
    print(f"SEC-169 RPC method param canonicality: {len(checks)}/{len(checks)} GREEN")
