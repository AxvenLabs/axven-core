...
The final journal must retain the checkpointed prefix byte-for-byte at the semantic-entry level and link entries by predecessor hashes. Same-parent final checkpoint substitution is rejected fail-closed. The detached selftest keeps the 35/35 expected cases matrix covering journal rewrites, rollback, revocation omission, quorum downgrade, signature mutation, noncanonical evidence, and signed fork substitution.
