...
DAEMON = ROOT / "daemon_lifecycle_test.py"
MANIFEST = ROOT / "release_manifest.json"
WORKFLOW = ROOT / ".github" / "workflows" / "sec129-fixture-repair.yml"
...
assert src.count(old) == 1, "SEC-129 daemon fixture anchor changed"
src = src.replace(old, new, 1)
DAEMON.write_text(src, encoding="utf-8", newline="\n")
